...
export function Debtors({ onAsk, frank }) {
  return (
    <div className="fade-up" style={{ color: C.sub, fontSize: 12 }}>
      <div style={{ padding: '20px', background: C.card, border: `1px solid ${C.border}`, borderRadius: 8 }}>
        <div style={{ fontSize: 18, fontWeight: 700, color: C.frank, marginBottom: 8 }}>Debtors</div>
        ...
        <button onClick={() => onAsk('Tell me about the Debtors for Wonderland Educare')}
