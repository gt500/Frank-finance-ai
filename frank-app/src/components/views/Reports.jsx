...
export function Reports({ onAsk, frank }) {
  return (
    <div className="fade-up" style={{ color: C.sub, fontSize: 12 }}>
      <div style={{ padding: '20px', background: C.card, border: `1px solid ${C.border}`, borderRadius: 8 }}>
        <div style={{ fontSize: 18, fontWeight: 700, color: C.frank, marginBottom: 8 }}>Reports</div>
        ...
        <button onClick={() => onAsk('Tell me about the Reports for Wonderland Educare')}
